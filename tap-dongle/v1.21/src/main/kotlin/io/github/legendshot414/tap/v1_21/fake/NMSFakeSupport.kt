...
package io.github.legendshot414.tap.v1_21.fake

import com.destroystokyo.paper.profile.ProfileProperty
import com.mojang.authlib.GameProfile
import com.mojang.authlib.properties.Property
import io.github.legendshot414.tap.fake.FakeSkinParts
import io.github.legendshot414.tap.fake.FakeSupport
import io.github.legendshot414.tap.v1_21.protocol.NMSPacketContainer
...
class NMSFakeSupport : FakeSupport {
    ...
    override fun createSpawnPacket(entity: Entity): Array<NMSPacketContainer> {
        ...
        val serverEntity = ServerEntity(serverLevel, nmsEntity, 0, false, {}, emptySet())

        packets.add(NMSPacketContainer(nmsEntity.getAddEntityPacket(serverEntity)))

...
package io.github.legendshot414.tap.v1_21_3.protocol
...
class NMSPacketSupport : PacketSupport {
    ...
    override fun entityTeleport(
        ...
        val packet = ClientboundTeleportEntityPacket(entityId, change, emptySet(), onGround)
        return NMSPacketContainer(packet)
    }
    ...
    override fun entityHeadLook(entityId: Int, yaw: Float): NMSPacketContainer {
        ...
        return NMSPacketContainer(ClientboundRotateHeadPacket.STREAM_CODEC.decode(byteBuf))
    }
    ...
    override fun entityAnimation(
        ...
        return NMSPacketContainer(ClientboundAnimatePacket.STREAM_CODEC.decode(byteBuf))
    }

...
package io.github.legendshot414.tap.v1_21_4.fake
...
import io.github.legendshot414.tap.v1_21_4.protocol.NMSPacketContainer
...
class NMSFakeSupport : FakeSupport {
    ...
    override fun <T : Entity> createEntity(entityClass: Class<out Entity>, world: World): T {
        return NMSEntityTypes.findType(entityClass).run {
            ...
            this.create(nmsWorld, EntitySpawnReason.LOAD)?.bukkitEntity as T
        }
    }
